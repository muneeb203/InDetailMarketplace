...
import { DetailerMobileCard } from './MobileOptimizedCard';
    ...
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="md:hidden">
        <MobileSearchHeader
          ...
          resultsCount={rankedDetailers.length}
        ...
        <div className="p-4 space-y-3">
          {rankedDetailers.map((detailer, index) => (
            ...
            >
              <DetailerMobileCard
                detailer={detailer}
                onSelect={() => onSelectDetailer(detailer)}
                onMessage={() => {/* Handle message */}}
                onRequestQuote={() => onRequestQuote(detailer)}
              />
            </motion.div>
          ))}
