...
export function GalleryLightbox({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95">
      ...
      {selectedIndex === null && (
        <div className="w-full h-full overflow-y-auto p-6 sm:p-12">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-6">Before & After Gallery</h2>
      ...
      {/* Detail view (pinch zoom placeholder) */}
      {selectedItem && (
        <div className="w-full h-full flex items-center justify-center p-6">
          <button
            onClick={handleCloseDetail}
            className="absolute top-4 left-4 w-12 h-12 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm flex items-center justify-center transition-colors"
          ...
          <div className="max-w-5xl w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              <div>
                <div className="text-xs font-medium text-white/60 uppercase tracking-wide mb-2">Before</div>
                <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-gray-700 to-gray-800 flex items-center justify-center">
                  <span className="text-8xl opacity-30">🚗</span>
                </div>
              </div>
              <div>
                <div className="text-xs font-medium text-green-400 uppercase tracking-wide mb-2">After</div>
                <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center">
            ...
            <div className="text-center">
              ...
              <p className="text-white/40 text-sm mt-4">Pinch to zoom • Swipe for next</p>
            </div>
          </div>
        </div>
      )}
