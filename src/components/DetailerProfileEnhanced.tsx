...
const mockProfile: ProfileData = {
  ...
  specialties: ['Ceramic Coating', 'Paint Correction', 'Interior Deep Clean', 'Engine Bay Clean', 'Fleet Services'],
  operatingHours: {
...
export function DetailerProfileEnhanced() {
    ...
    <div className="h-full flex flex-col bg-gradient-to-b from-[#EAF5FF] to-white overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="px-4 py-4 space-y-4">
          ...
          {/* Exposure Metrics */}
          <Card className="p-4 border bg-gradient-to-br from-blue-50 to-white">
            <h2 className="text-sm mb-3 flex items-center gap-2">
              <div className="w-6 h-6 bg-[#0078FF]/10 rounded-lg flex items-center justify-center">
                <TrendingUp className="w-3 h-3 text-[#0078FF]" />
              </div>
              Marketing & Exposure
            </h2>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="p-2.5 bg-white rounded-lg border border-blue-100 cursor-help">
                      <div className="flex items-center gap-1.5 mb-1">
                        <Eye className="w-3.5 h-3.5 text-[#0078FF]" />
                        <span className="text-xs text-gray-600">Profile Views</span>
                      </div>
                      <p className="text-sm text-gray-900">
                        {profileData.profileViews7d} <span className="text-xs text-gray-500">/ 7d</span>
                      </p>
                      <p className="text-xs text-gray-500 mt-0.5">
                        {profileData.profileViews30d} in 30d
                      </p>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="text-xs">
                    <p>Number of times clients viewed your profile</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="p-2.5 bg-white rounded-lg border border-blue-100 cursor-help">
                      <div className="flex items-center gap-1.5 mb-1">
                        <MessageSquare className="w-3.5 h-3.5 text-[#0078FF]" />
                        <span className="text-xs text-gray-600">Leads Received</span>
                      </div>
                      <p className="text-sm text-gray-900">
                        {profileData.leadsReceived7d} <span className="text-xs text-gray-500">/ 7d</span>
                      </p>
                      <p className="text-xs text-gray-500 mt-0.5">
                        {profileData.leadsReceived30d} in 30d
                      </p>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="text-xs">
                    <p>Quote requests from potential clients</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="p-2.5 bg-white rounded-lg border border-blue-100 cursor-help">
                      <div className="flex items-center gap-1.5 mb-1">
                        <Target className="w-3.5 h-3.5 text-[#0078FF]" />
                        <span className="text-xs text-gray-600">Conversion</span>
                      </div>
                      <p className="text-sm text-gray-900">{profileData.conversionRate}%</p>
                      <p className="text-xs text-green-600 mt-0.5">Above avg</p>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="text-xs">
                    <p>Percentage of leads that became bookings</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="p-2.5 bg-white rounded-lg border border-blue-100 cursor-help">
                      <div className="flex items-center gap-1.5 mb-1">
                        <Zap className="w-3.5 h-3.5 text-[#0078FF]" />
                        <span className="text-xs text-gray-600">Response Time</span>
                      </div>
                      <p className="text-sm text-gray-900">{profileData.avgResponseTime}</p>
                      <p className="text-xs text-green-600 mt-0.5">Excellent</p>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="text-xs">
                    <p>Average time to respond to leads</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
